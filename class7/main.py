...
def on_message(topic, msg):
    msg = msg.decode("utf-8")  # Byte to String
    topic = topic.decode("utf-8")
    print(f"my subscribe topic is:{topic},msg:{msg}")
...
mqClient0.subscribe("gay")  # 設定想訂閱的主題
#########################主程式#########################
